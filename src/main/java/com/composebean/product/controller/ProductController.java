...
public class ProductController {
    ...
    public ResponseEntity<ProductListResponse> getProducts(
            @Parameter(description = "검색할 상품명", example = "원두")
    ...
    @Operation(
            summary = "상품 등록",
            description = "상품명, 가격, 설명, 이미지 URL, 재고 수량을 입력하여 상품을 등록한다."
    )
    ...
    @Operation(
            summary = "상품 정보 수정",
            description = "상품 ID에 해당하는 상품의 이름, 가격, 설명, 이미지 URL을 수정한다."
    )
    ...
    @ApiResponse(responseCode = "200", description = "상품 재고 수정 성공")
    @ApiResponse(
            responseCode = "400",
            description = "요청값 검증 실패",
            content = @Content(
